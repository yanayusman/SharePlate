...
public class CommunityVolunteeringFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_community_volunteering, container, false);
        ...
        eventRepo.getAllEventItems(new EventRepo.OnEventItemsLoadedListener() {
            ...
            public void onEventItemsLoaded(List<Event> events) {
                ...
                allEvents = events.stream()
                        .filter(event -> "Volunteering".equalsIgnoreCase(event.getTypeOfEvents()))
